...
export default async function Home() {
  const featuredPostsPromise = blogService.getBlogPosts({
    isFeatured: true,
  });
  ...
  return (
    <div className="max-w-7xl mx-auto px-4">
      <div className="mb-12 mt-8 h-[calc(100vh-80px)] flex flex-col justify-center">
        <div className="relative w-full h-96 mb-6">
          ...
          <Image
            src="https://images.unsplash.com/photo-1499750310107-5fef28a66643?w=1920&q=100"
            fill
            priority // there will not be lazy-loading, rather it will get priority before other to load
            alt="Hero"
            className="object-cover rounded-md"
          />
        </div>
      ...
      {featuredPosts?.data?.data?.data &&
        featuredPosts.data.data.data.length > 0 && (
          <div className="mb-12">
      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-5">
          ...
          {posts?.data?.data?.data.map((post: BlogPost) => (
